...
class DetectionModel(nn.Module):
    ...
    def inference(
        ...
        offset_x = torch.reshape(predictions[None,2,:,:], (H, W))[k_indicies[0], k_indicies[1]]
        centroids = torch.cat((torch.flatten(offset_x), torch.flatten(offset_y)), dim=1) + k_local_max
        '''
